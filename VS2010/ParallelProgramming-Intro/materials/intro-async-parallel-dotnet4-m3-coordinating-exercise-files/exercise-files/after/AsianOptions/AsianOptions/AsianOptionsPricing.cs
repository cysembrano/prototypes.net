...
namespace AsianOptions
{
	...
	public class AsianOptionsPricing
	{
		...
		/// </summary>
		/// <param name="ct">Cancellation token for cancelling parallel execution.</param>
		...
		public static double Simulation(CancellationToken ct, Random rand, double initial, double exercise, double up, double down, double interest, long periods, long sims)
		{
			...
			{
				//
				// are we being asked to cancel?  If so, throw exception as per 
				// design rule, and *DO NOT* handle this exception here 
