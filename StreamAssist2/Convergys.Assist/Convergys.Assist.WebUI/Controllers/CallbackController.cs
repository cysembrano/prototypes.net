...
namespace Convergys.Assist.WebUI.Controllers
{
    ...
    public class CallbackController : BaseController
    {
                                                 ...
                                                 decimal? emp)
        {
            ...
            if (found != null)
            {
                if (!HasViewEditRights(empView, found, teamlist))
        ...
        /// </summary>
        private bool HasViewEditRights(EmployeeView empView, Callback callback, Team[] teams)
        {
        ...
        public ActionResult View(EmployeeView empView, int? id)
        {
            ...
            if (!HasViewEditRights(model.LoggedOnEmployee, model.Callback, model.TeamList))
                return View("AccessInvalid");
